...
class RuleCheckerTest extends TestCase
{
    ...
    public function test_can_exclude_files_or_directories_from_multiple_dir_class_set_with_violations(): void
    {
        ...
        self::assertEquals(
            [
                new Violation(
                    'Arkitect\Tests\Fixtures\Animal\CatTestCase',
                    'should implement Arkitect\Tests\Fixtures\Animal\AnimalInterface because this tests that expression exceptions fail',
                    null,
                    'Animal/CatTestCase.php'
                ),
                new Violation(
                    'Arkitect\Tests\Fixtures\Fruit\DwarfCavendishBanana',
                    'should implement Arkitect\Tests\Fixtures\Fruit\FruitInterface because this tests that string exceptions fail',
                    null,
                    'Fruit/DwarfCavendishBanana.php'
                ),
            ],
            $violations->toArray()
        );
