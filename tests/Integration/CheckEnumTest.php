...
class CheckEnumTest extends TestCase
{
    public function test_naming_is_enforced(): void
    {
        ...
        self::assertStringContainsString("should have a name that matches *Enum\nbecause", $runner->getViolations()->get(0)->getError());
        self::assertStringContainsString("Aclass should be an enum\nbecause Enums should be enums", $runner->getViolations()->get(1)->getError());
    }
